...
module.exports = function (app) {
    ...
    NotFoundController.prototype._exec = function () {
        ...
        if (this.req.inNotFoundProcess) {
            // 如果已经再NOT FOUND流程中，则直接终止request
            this.req.socket.destroy();
            return;
        }
        this.req.inNotFoundProcess = true;
    ...
    InternalErrorController.prototype._exec = function () {
        ...
        if (this.req.inInternalErrorProcess) {
            // 如果已经再错误处理流程中，则直接终止request
            this.req.socket.destroy();
            return;
        }
        this.req.inInternalErrorProcess = true;
